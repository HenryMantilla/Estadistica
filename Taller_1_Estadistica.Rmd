...
:   La función de distribución de probabilidad es una función matemática que sirve y se emplea para definir cómo se distribuye una variable de tipo numérico en una población de interés para su estudio. Básicamente, describe la probabilidad relativa según la cual la variable aleatoria tomará un valor determinado.
