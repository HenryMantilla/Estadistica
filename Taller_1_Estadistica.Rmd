...
-   **Distribucion Binomial Discreta**
    ...
    -   Henry tiene una efectividad de aciertos en sus tiros libres de basquetball del 60%. Si Henry lanza 12 tiros libres, cual es la probabilidad de que de esos 12 tiros libres, anote exactamente 10?
    ...
    -   Cual es la probabilidad que anote 12 tiros libres o menos?

        ```{r}

        ```

-   **Distribucion Exponencial Cotinua**
