...
:   La funcion de distribucion cuantil $Q(x)$ es la inversa de la funcion de distribucion acumulada $F(x)$, esta especifica el valor de la variable aleatoria de manera que la
